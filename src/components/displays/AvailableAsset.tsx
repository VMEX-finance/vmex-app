...
const AvailableAssetDisplay = ({ asset, amount, balance, selectable, selected, setSelected, background = true }: IAvailableAssetDisplayProps) => {
  return (
    <div 
      className={`
    ...
    >
      <AssetDisplay 
        name={asset}
        logo={`/tokens/token-${asset.toUpperCase()}.svg`}
      />
      <div className="flex flex-col text-right">
        <span className="text-neutral-600 text-sm">{amount || 0} {asset.toUpperCase()}</span>
