    ...
    return (
        ...
        >
            <button
                ...
                } rounded-l-md py-1 pb-1.5 md:pb-1 px-4 transition duration-100 hover:opacity-90`}
            ...
            <button
                ...
                } rounded-r-md py-1 pb-1.5 md:pb-1 px-4 transition duration-100 hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-80`}
