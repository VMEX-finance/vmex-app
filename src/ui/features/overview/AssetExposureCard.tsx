...
import {
    _mockTrancheAssetExposure,
    _mockTrancheAssetExposure2,
    _mockTrancheAssetExposure3,
} from '../../../models/asset-exposure-model';
                        ...
                        <Tab className="mx-2">
                            {({ selected }) => (
                                <button
                                    className={[
                                        selected
                                            ? 'p-2 rounded-lg bg-white text-black border-black border-[2px]'
                                            : 'p-3 rounded-lg bg-gray-100 text-gray-400',
                                    ].join(' ')}
                                >
                                    {' '}
                                    Tranch 0
