export const VMEXWETH_ABI = [
        ...
        inputs: [
            {
                components: [
                    ...
                    { internalType: 'uint256', name: 'normalizedWeight0', type: 'uint256' },
                    { internalType: 'uint256', name: 'normalizedWeight1', type: 'uint256' },
    ...
    },
    {
        ...
        outputs: [
            ...
            { internalType: 'uint256', name: 'oracleSampleCreationTimestamp', type: 'uint256' },
    ...
    },
    {
        inputs: [
            {
                components: [
                    { internalType: 'enum IPriceOracle.Variable', name: 'variable', type: 'uint8' },
