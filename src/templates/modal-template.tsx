        ...
        <Dialog as="div" className="relative z-10" onClose={() => closeDialog("loan-asset-dialog")}>
          ...
          <div className="fixed z-10 inset-0 overflow-y-auto">
            <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
              ...
              >
                <Dialog.Panel className="relative bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-sm sm:w-full sm:p-6 font-basefont">
                  { children }
                </Dialog.Panel>
              </Transition.Child>
            </div>
